...
namespace Swagger.Net.XmlComments
{
    public static class XmlCommentsIdHelper
    {
        ...
        private static Dictionary<string, int> GetTypeParameterPositions(Type type)
        {
        ...
        private static void AppendMethodName(MethodInfo methodInfo, StringBuilder builder)
        {
            ...
            var genericParametersPositions = GetTypeParameterPositions(methodInfo.DeclaringType);
